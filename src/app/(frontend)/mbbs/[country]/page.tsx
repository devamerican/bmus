    ...
    <div className=" bg-gray-50">
      ...
      <section className="relative h-96">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center p-4">
          <h3 className="text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">{pageContent.hero.title}</h3>
      ...
      <main className="section-container mx-auto px-4 py-8">
        <div className="">
          ...
          <div>
            ...
            <h2 className="text-h2 mb-6 mt-20">Medical Universities in Russia</h2>
            ...
            <CardContent className='p-0' >
              ...
              <Table  >
                ...
                <TableBody >
                  {pageContent.universities.map((university, index) => (
            ...
            <Card className="mb-8">
              <CardContent className="pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                  {pageContent.aboutRussia.facts.map((fact, index) => (
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                <ul className="space-y-4">
                  {pageContent.eligibility.map((item, index) => (
            ...
            <Card className="mb-8">
              ...
              <CardContent className="">
                <ul className="space-y-4">
                  {pageContent.whyChooseRussia.map((item, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span>{item}</span>
                    </li>
            ...
            <h3 className="text-h3 mb-6">City Attractions Russia</h3>
            <div className=" mb-8">
                <Image 
                  src="/rus-city.jpg" 
                  alt="city attraction" 
